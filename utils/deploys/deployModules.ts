...
export default class DeployModules {
  ...
  public async deployComponentManageModule(controller: Address): Promise<ComponentManageModule> {
    return await new ComponentManageModuleFactory(this._deployerSigner).deploy(controller);
  }
